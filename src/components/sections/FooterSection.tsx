...
const FooterSection = () => {
  const data = {
    ...
    left: ["Cookies Policy", "Legal Terms", "Privacy Policy"],
    right: [
      "Instagram",
      "LinkedIn",
      "Twitter",
  ...
  return (
    <section>
      ...
      <div className="flex flex-col xl:flex-row flex-wrap gap-8 justify-between">
        ...
        <div className="bg-[#E9E9E9] p-4 md:p-[26px] flex gap-2 items-center rounded-[8px]">
...
function CustomLink({ item }: { item: string }) {
  return (
    <p className="font-bold text-14 mb-4">
      <a href="#">{item}</a>
    </p>
  );
}
